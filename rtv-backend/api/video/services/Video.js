...
const basicMethods = {
  ...
  fetch: params => {
    ...
    return Video.findOne(_.pick(params, _.keys(Video.schema.paths))).populate(
      populate,
    );
  },
  ...
  count: params => {
    ...
    return Video.count().where(filters.where);
  },
  ...
  remove: async params => {
    ...
    const data = await Video.findOneAndRemove(params, {}).populate(populate);
